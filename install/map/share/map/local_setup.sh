...
: ${AMENT_CURRENT_PREFIX:="/home/p3zz/Documents/uni/robot-planning-project/install/map"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/map/environment/library_path.sh"
