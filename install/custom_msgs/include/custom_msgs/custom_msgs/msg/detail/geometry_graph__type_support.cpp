...
{
  new (message_memory) custom_msgs::msg::GeometryGraph(_init);
}

void GeometryGraph_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::GeometryGraph *>(message_memory);
...
{
  const auto * member = reinterpret_cast<const std::vector<custom_msgs::msg::Edges> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<custom_msgs::msg::Edges> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<custom_msgs::msg::Edges> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__GeometryGraph__edges(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const custom_msgs::msg::Edges *>(
    get_const_function__GeometryGraph__edges(untyped_member, index));
  auto & value = *reinterpret_cast<custom_msgs::msg::Edges *>(untyped_value);
  value = item;
}
...
void assign_function__GeometryGraph__edges(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<custom_msgs::msg::Edges *>(
    get_function__GeometryGraph__edges(untyped_member, index));
  const auto & value = *reinterpret_cast<const custom_msgs::msg::Edges *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GeometryGraph_message_member_array[3] = {
  {
    ...
    offsetof(custom_msgs::msg::GeometryGraph, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::GeometryGraph, nodes),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<custom_msgs::msg::Edges>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::GeometryGraph, edges),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GeometryGraph_message_members = {
  ...
  3,  // number of fields
  sizeof(custom_msgs::msg::GeometryGraph),
...
get_message_type_support_handle<custom_msgs::msg::GeometryGraph>()
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::GeometryGraph_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, GeometryGraph)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::GeometryGraph_message_type_support_handle;
}
