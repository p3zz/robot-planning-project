...
bool custom_msgs__msg__obstacle_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_msgs.msg._obstacle_msg.ObstacleMsg", full_classname_dest, 41) == 0);
  }
  custom_msgs__msg__ObstacleMsg * ros_message = _ros_message;
  {  // header
...
PyObject * custom_msgs__msg__obstacle_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_msgs.msg._obstacle_msg");
