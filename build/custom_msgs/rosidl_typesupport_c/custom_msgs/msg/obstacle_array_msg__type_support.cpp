...
static const _ObstacleArrayMsg_type_support_symbol_names_t _ObstacleArrayMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msgs, msg, ObstacleArrayMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_msgs, msg, ObstacleArrayMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, custom_msgs, msg, ObstacleArrayMsg)() {
  return &::custom_msgs::msg::rosidl_typesupport_c::ObstacleArrayMsg_message_type_support_handle;
}
