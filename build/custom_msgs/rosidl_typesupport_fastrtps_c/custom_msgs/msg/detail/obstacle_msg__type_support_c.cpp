...
#include "custom_msgs/msg/detail/obstacle_msg__rosidl_typesupport_fastrtps_c.h"
...
using _ObstacleMsg__ros_msg_type = custom_msgs__msg__ObstacleMsg;
...
static uint32_t _ObstacleMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msgs__msg__ObstacleMsg(
...
static size_t _ObstacleMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msgs__msg__ObstacleMsg(
