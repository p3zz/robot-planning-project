...
{
  new (message_memory) custom_msgs::msg::Edges(_init);
}

void Edges_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msgs::msg::Edges *>(message_memory);
  typed_message->~Edges();
}
...
void fetch_function__Edges__node_ids(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint32_t *>(
    get_const_function__Edges__node_ids(untyped_member, index));
  auto & value = *reinterpret_cast<uint32_t *>(untyped_value);
  value = item;
}

void assign_function__Edges__node_ids(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint32_t *>(
    get_function__Edges__node_ids(untyped_member, index));
...
void fetch_function__Edges__weights(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__Edges__weights(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__Edges__weights(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__Edges__weights(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Edges_message_member_array[2] = {
  {
    ...
    offsetof(custom_msgs::msg::Edges, node_ids),  // bytes offset in struct
    ...
    fetch_function__Edges__node_ids,  // fetch(index, &value) function pointer
    assign_function__Edges__node_ids,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msgs::msg::Edges, weights),  // bytes offset in struct
    nullptr,  // default value
    ...
    fetch_function__Edges__weights,  // fetch(index, &value) function pointer
    assign_function__Edges__weights,  // assign(index, value) function pointer
...
{
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::Edges_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs, msg, Edges)() {
  return &::custom_msgs::msg::rosidl_typesupport_introspection_cpp::Edges_message_type_support_handle;
}
