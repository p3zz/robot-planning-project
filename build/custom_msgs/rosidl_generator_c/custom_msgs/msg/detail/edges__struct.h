...
#ifndef CUSTOM_MSGS__MSG__DETAIL__EDGES__STRUCT_H_
#define CUSTOM_MSGS__MSG__DETAIL__EDGES__STRUCT_H_
...
/// Struct defined in msg/Edges in the package custom_msgs.
/**
  * base-zero index of all the verticies this particular vertice connects to (edges)
 */
typedef struct custom_msgs__msg__Edges
{
...
// Struct for a sequence of custom_msgs__msg__Edges.
typedef struct custom_msgs__msg__Edges__Sequence
{
...
#endif  // CUSTOM_MSGS__MSG__DETAIL__EDGES__STRUCT_H_
