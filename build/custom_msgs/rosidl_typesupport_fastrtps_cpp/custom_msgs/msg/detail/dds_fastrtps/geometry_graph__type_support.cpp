...
#include "custom_msgs/msg/detail/geometry_graph__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_msgs::msg::Edges &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_msgs::msg::Edges &);
size_t get_serialized_size(
  const custom_msgs::msg::Edges &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const custom_msgs::msg::GeometryGraph & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msgs::msg::GeometryGraph & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: edges
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        custom_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Edges(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const custom_msgs::msg::GeometryGraph *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msgs::msg::GeometryGraph *>(
    untyped_ros_message);
...
{
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_GeometryGraph__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs, msg, GeometryGraph)() {
  return &custom_msgs::msg::typesupport_fastrtps_cpp::_GeometryGraph__handle;
}
